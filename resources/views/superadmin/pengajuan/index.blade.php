...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex justify-content-between">
        ...
        <!-- <a href="{{ route('superadmin.pengajuan.create') }}" class="btn btn-primary btn-sm">
                    ...
                    @if(isset($pengajuan) && $pengajuan->count() > 0)
                        @foreach ($pengajuan as $item)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Detail -->
                                    <a href="{{ route('superadmin.pengajuan.show', $item->id) }}" class="btn btn-info btn-sm mb-1">
                                        <i class="fas fa-eye"></i> Detail
                                    </a>
                                    
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('superadmin.pengajuan.edit', $item->id) }}" class="btn btn-warning btn-sm mb-1">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    
                                    <!-- Form untuk menghapus pengajuan -->
                                    <form action="{{ route('superadmin.pengajuan.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
