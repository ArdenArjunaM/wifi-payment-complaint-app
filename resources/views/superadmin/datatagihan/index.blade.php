...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/suoeradmin/dashboard">
                        ...
                        <td>
                            <div class="btn-group-vertical" role="group">
                                ...
                                @if(!$isLunas)
                                    ...
                                    @if(Route::has('superadmin.datatagihan.kirim'))
                                        <a href="{{ route('superadmin.datatagihan.kirim', $item->id_tagihan) }}" 
                                    ...
                                    <!-- Tombol Tandai Lunas -->
                                    @if(Route::has('superadmin.datatagihan.markAsPaid'))
                                        <form action="{{ route('superadmin.datatagihan.markAsPaid', $item->id_tagihan) }}" 
                                ...
                                <!-- Tombol Detail -->
                                @if(Route::has('superadmin.datatagihan.show'))
                                    <a href="{{ route('superadmin.datatagihan.show', $item->id_tagihan) }}" 
                                ...
                                <!-- Tombol Edit -->
                                @if(Route::has('superadmin.datatagihan.edit'))
                                    <a href="{{ route('superadmin.datatagihan.edit', $item->id_tagihan) }}" 
                                ...
                                <!-- Tombol Hapus -->
                                @if(Route::has('superadmin.datatagihan.destroy'))
                                    <form action="{{ route('superadmin.datatagihan.destroy', $item->id_tagihan) }}" 
                                          method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
