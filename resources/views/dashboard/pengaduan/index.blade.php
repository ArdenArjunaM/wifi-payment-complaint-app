            ...
            <!-- Main Content -->
                ...
                <d class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengaduan Wifi</h1>
                    ...
                    @if(isset($pengaduan) && $pengaduan->count() > 0)
                        @foreach ($pengaduan as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('dashboard.pengaduan.update', $item->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                ...
                                <td>
                                    <form action="{{ route('dashboard.pengaduan.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
