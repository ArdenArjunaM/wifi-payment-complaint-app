...
<head>
    ...
    <title>Edit Pelanggan - EVAN NETWORK</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('dashboard.datapelanggan.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge badge-warning">Edit Data</span>
                        </div>
                        
                        <div class="card-body">
                            <form action="{{ route('dashboard.datapelanggan.update', $pelanggan->id_user) }}" method="POST">
                                @csrf
                                @method('PUT')
                                       ...
                                       <!-- Paket -->
                                                ...
                                                @if(isset($paketWifi) && $paketWifi->count() > 0)
                                                    @foreach ($paketWifi as $paket)
                                                        <option value="{{ $paket->id }}" 
                                                            {{ old('paket', $pelanggan->paketWifi->id ?? '') == $paket->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select 
                                                ...
                                                name="status" 
                                                required>
                                                <option value="aktif" {{ old('status', $pelanggan->status) == 'berlangganan' ? 'selected' : '' }}>Berlangganan</option>
                                                <option value="non-aktif" {{ old('status', $pelanggan->status) == 'belum berlangganan' ? 'selected' : '' }}>Belum Berlangganan</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <ul class="mb-0 mt-2">
                                                <li>ID Pelanggan: {{ $pelanggan->id }}</li>
                                                <li>Tanggal Bergabung: {{ $pelanggan->created_at ? $pelanggan->created_at->format('d F Y') : 'Tidak diketahui' }}</li>
                                                <li>Terakhir Diupdate: {{ $pelanggan->updated_at ? $pelanggan->updated_at->format('d F Y H:i') : 'Belum pernah' }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('dashboard.datapelanggan.index') }}" class="btn btn-secondary">
