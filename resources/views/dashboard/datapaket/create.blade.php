...
<head>
    ...
    <title>Tambah Paket Wifi - EVAN NETWORK</title>
...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/datapaket">Data Paket</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Paket Wifi</h1>
                        <a href="{{ route('dashboard.datapaket.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <i class="fas fa-plus"></i> Form Tambah Paket Wifi
                            </h6>
                            <span class="badge badge-success">Paket Baru</span>
                        </div>
                        
                        <div class="card-body">
                            <form action="{{ route('dashboard.datapaket.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea 
                                                ...
                                                required>{{ old('deskripsi_paket') }}</textarea>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="mt-3">
                                                <!-- Default placeholder -->
                                                <div class="card" id="defaultPlaceholder">
                                                    <div class="card-header py-2">
                                                        <small class="font-weight-bold text-muted">Preview:</small>
                                                    </div>
                                                    <div class="card-body p-3 text-center text-muted">
                                                        <i class="fas fa-image fa-3x mb-2"></i>
                                                        <p class="mb-0">Pilih gambar untuk preview</p>
                                                    </div>
                                                </div>
                                                
                                                <!-- Preview untuk gambar baru -->
                                                <div class="card" id="newImagePreview" style="display: none;">
                                                    <div class="card-header py-2">
                                                        <small class="font-weight-bold text-success">Preview Gambar:</small>
                                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('dashboard.datapaket.index') }}" class="btn btn-secondary">
    ...
    <script>
        ...
        function resetForm() {
            ...
            document.getElementById('defaultPlaceholder').style.display = 'block';
        }
