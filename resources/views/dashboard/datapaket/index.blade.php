...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        ...
        <!-- Tombol Tambah Paket -->
        <a href="{{ route('dashboard.datapaket.create') }}" class="btn btn-info btn-sm">
            Tambah Paket
        </a>
    </div>
    <div class="card-body">
                    ...
                    @if(isset($paketWifi) && $paketWifi->count() > 0)
                        @foreach ($paketWifi as $paket)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dashboard.datapaket.edit', $paket->id_paket_wifi) }}" class="btn btn-primary btn-sm">Edit</a>
                                    
                                    <!-- Form untuk menghapus -->
                                    <form action="{{ route('dashboard.datapaket.destroy', $paket->id_paket_wifi) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
