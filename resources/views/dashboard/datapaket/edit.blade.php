                ...
                <div class="container-fluid">
                    ...
                    @if(isset($paketWifi))
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('dashboard.datapaket.update', $paketWifi->id_paket_wifi) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body text-center">
                                <div class="text-muted">
                                    ...
                                    <a href="{{ route('dashboard.datapaket.index') }}" class="btn btn-primary">
