            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/buattagihan">Buat Tagihan</a>
            ...
            <!-- Main Content -->
                ...
                <d class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengajuan Wifi</h1>
                    ...
                    @if(isset($pengajuan) && $pengajuan->count() > 0)
                        @foreach ($pengajuan as $item)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Detail -->
                                    <a href="{{ route('dashboard.pengajuan.show', $item->id) }}" class="btn btn-info btn-sm mb-1">
                                        <i class="fas fa-eye"></i> Detail
                                    </a>
                                    
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('dashboard.pengajuan.edit', $item->id) }}" class="btn btn-warning btn-sm mb-1">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    
                                    <!-- Form untuk menghapus pengajuan -->
                                    <form action="{{ route('dashboard.pengajuan.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
